...
@Component({
    selector: 'app-pre-pos-fast-food',
    imports: [MaterialModule, RouterModule, CommonModule, SaleItemsComponent],
    templateUrl: './pre-pos-fast-food.component.html',
    styleUrl: './pre-pos-fast-food.component.sass'
})
export class PrePosFastFoodComponent {
