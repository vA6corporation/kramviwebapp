...
export class PaymentPurchasesService {
    ...
    create(paymentPurchase: any, purchaseId: any): Observable<PaymentPurchaseModel> {
        return this.httpService.post(`paymentPurchases/${purchaseId}`, { paymentPurchase })
    }

    update(paymentPurchase: any, purchasePurchaseId: any, purchaseId: any): Observable<void> {
        return this.httpService.put(`paymentPurchases/${purchasePurchaseId}/${purchaseId}`, { paymentPurchase })
    }

    delete(paymentPurchaseId: any, purchaseId: any): Observable<void> {
