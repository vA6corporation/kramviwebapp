...
export class BoardsComponent {
    ...
    displayedColumns: string[] = ['name', 'countSale', 'totalCharge']
        ...
        if (this.formGroup.valid) {
            ...
            this.boardsService.getSummaryBoardsByRangeDate(
                ...
                next: summaryBoards => {
                    ...
                    this.totalTotalSale = summaryBoards.map(e => e.totalCharge).reduce((a, b) => a + b, 0)
                    const data = {
                        datasets: [
                            {
                                label: 'Dataset 1',
                                data: summaryBoards.slice(0, 10).map(e => e.totalCharge || 0),
                                fill: true
                            },
                        ]
                    }
