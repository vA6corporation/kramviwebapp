...
@Component({
    selector: 'app-copy-sales',
    imports: [MaterialModule, CommonModule, RouterModule, SaleItemsComponent],
    templateUrl: './copy-sales.component.html',
    styleUrl: './copy-sales.component.sass',
})
export class CopySalesComponent {
    ...
    ngOnInit(): void {
        ...
        this.salesService.getSaleById(saleId).subscribe(sale => {
            //this.salesService.setProforma(proforma)
