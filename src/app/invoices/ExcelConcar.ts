    ...
    buildBody(
        ...
        sales.forEach((sale, index) => {
            ...
            this.body.push([
                ...
                '',
                'D',
                sale.cdr && sale.cdr.sunatCode === '0' && sale.deletedAt === null ? Number(sale.charge.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })) : 0,
                0,
                0,
            ...
            this.body.push([
                ...
                '',
                'H',
                sale.cdr && sale.cdr.sunatCode === '0' && sale.deletedAt === null ? Number(sale.igv.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })) : 0,
                0,
                0,
                sale.invoiceCode === '01' ? 'FT' : 'BV',
                `${sale.invoicePrefix}${office.serialPrefix}-${sale.invoiceNumber}`,
            ...
            this.body.push([
                ...
                '',
                'H',
                sale.cdr && sale.cdr.sunatCode === '0' && sale.deletedAt === null ? Number((sale.charge - sale.igv).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })) : 0,
                0,
                0,
                sale.invoiceCode === '01' ? 'FT' : 'BV',
                `${sale.invoicePrefix}${office.serialPrefix}-${sale.invoiceNumber}`,
