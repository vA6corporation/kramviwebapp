...
export class InIncidentsComponent {
        ...
        this.handleClickMenu$ = this.navigationService.handleClickMenu().subscribe(id => {
            ...
            if (startDate && endDate) {
                ...
                for (let index = 0; index < this.$length() / chunk; index++) {
                    const promise = lastValueFrom(this.incidentsService.getInIncidentItemsByPage(index + 1, chunk, this.params))
    ...
    fetchData() {
        this.navigationService.loadBarStart()
        this.incidentsService.getInIncidentItemsByPage(
            this.pageIndex + 1,
            this.pageSize,
            this.params
    ...
    onDeleteIncident(incidentId: string, incidentItemId: string) {
        ...
        if (ok) {
            this.navigationService.loadBarStart()
            this.incidentsService.deleteInIncidentItem(incidentId, incidentItemId).subscribe(() => {
                this.navigationService.loadBarFinish()
