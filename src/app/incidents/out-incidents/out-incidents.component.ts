...
export class OutIncidentsComponent {
        ...
        this.handleClickMenu$ = this.navigationService.handleClickMenu().subscribe(id => {
            ...
            if (startDate && endDate) {
                ...
                for (let index = 0; index < this.length / chunk; index++) {
                    const promise = lastValueFrom(this.incidentsService.getIncidentOutItemsByPage(index + 1, chunk, this.params))
    ...
    fetchData() {
        this.navigationService.loadBarStart()
        this.incidentsService.getIncidentOutItemsByPage(
            this.pageIndex + 1,
            this.pageSize,
            this.params
    ...
    fetchCount() {
        this.incidentsService.getCountIncidentOutItems(this.params).subscribe(count => {
            this.length = count
        })
    }
