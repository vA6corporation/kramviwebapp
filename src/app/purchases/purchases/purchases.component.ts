                ...
                Promise.all(promises).then(values => {
                    ...
                    for (const purchase of purchases) {
                        ...
                        body.push([
                            ...
                            Number((purchase.charge - purchase.igv).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })),
                            Number((purchase.charge || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })),
                            Number((purchase.igv || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })),
                            Number((purchase.gravado || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })),
                            Number((purchase.exonerado || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })),
                            Number((purchase.inafecto || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })),
                            Number((purchase.gratuito || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })),
