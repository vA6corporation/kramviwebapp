...
export class AuthService {
    ...
    private modules: ModuleModel[] = [
        ...
        { label: 'Punto de venta', name: 'prePosFastFood', path: '/prePosFastFood', isActive: false, isAuthorized: false, icon: 'desktop_windows', info: 'Restaurantes FastFood (Con entregas)' },
