...
export class PaymentMethodsService {
    ...
    getPaymentMethodById(paymentMethodId: any): Observable<PaymentMethodModel> {
    ...
    update(paymentMethod: any, paymentMethodId: any): Observable<any> {
        return this.httpService.put(`paymentMethods/${paymentMethodId}`, { paymentMethod })
    }

    delete(paymentMethodId: any): Observable<void> {
