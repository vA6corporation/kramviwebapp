...
export class ProductsService {
    ...
    private linkProducts: Map<number, ProductModel[]> = new Map()

    setCacheLinkProducts(productId: any, products: ProductModel[]) {
        this.linkProducts.set(productId, products)
    }

    getCacheLinkProducts(productId: any): ProductModel[] | undefined {
    ...
    uploadImage(formData: FormData, productId: any): Observable<{ urlImage: string }> {
    ...
    getProductsByCategoryPage(categoryId: any, pageIndex: number, pageSize: number): Observable<ProductModel[]> {
    ...
    getCountProductsByCategory(categoryId: any): Observable<number> {
    ...
    updateTrackStock(productId: any): Observable<ProductModel> {
    ...
    restore(productId: any): Observable<void> {
